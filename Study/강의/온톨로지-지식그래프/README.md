...
| | | ↳ 부록 | S14-1 | 읽는 데 필요한 것들 — CNN·GCN · 행렬 W · 학습 절차 · 식 읽기 · basis 계산 | [S14-1-읽는-데-필요한-것들](S14-1-읽는-데-필요한-것들.md) | ✅ |
| | | ↳ 부록 | S14-2 | 이웃에서 오는 표현 — 공유 축 · 아키텍처 누출 · encoder와 decoder의 어긋남 | [S14-2-이웃에서-오는-표현](S14-2-이웃에서-오는-표현.md) | ✅ |
