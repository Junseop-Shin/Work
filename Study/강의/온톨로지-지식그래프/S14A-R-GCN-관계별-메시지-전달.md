...
> [S14-2 5절](S14-2-이웃에서-오는-표현.md#5-방향을-살린-encoder와-대칭만-아는-decoder)에 적었다.
...
> [S14-2 4절](S14-2-이웃에서-오는-표현.md#4-encoder가-만든-새로운-누출)에 적었다.
...
> [S14-2 8절](S14-2-이웃에서-오는-표현.md#8-온톨로지가-후보를-줄인다)에 적었다.
...
> 지표의 성질과 실험 표를 읽는 법은 [S14-1 9·10절](S14-1-읽는-데-필요한-것들.md#10-실험-파트-읽는-법)에
> 있다.
...
> [S14-2 6절](S14-2-이웃에서-오는-표현.md#6-실험-설계가-대비된다)에 적었다.
...
> raw와 filtered의 차이, 그리고 LinkFeat 행이 왜 표에 있는지는
